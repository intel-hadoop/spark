...
private[spark] object CoarseGrainedExecutorBackend extends Logging {
  ...
  private def run(
    ...
    SparkHadoopUtil.get.runAsSparkUser { () =>
      ...
      val env = SparkEnv.createExecutorEnv(driverConf, executorId, numaNodeId, hostname,
  ...
  def main(args: Array[String]) {
    ...
    run(driverUrl, executorId, hostname, numaNodeId, cores, appId, workerUrl, userClassPath)
    System.exit(0)
  }
